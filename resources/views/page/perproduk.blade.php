  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5 class="m-0 float-left">Laporan Penjualan Perproduk {{ date("d M Y", strtotime($tgl1)) }} - {{ date("d M Y", strtotime($tgl2)) }} <br> {{ $dt_cabang ? 'Outlet '. $dt_cabang->nama : ''}}</h5>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <canvas id="perproduk" width="400" height="180" class="bg-light"></canvas>
            </div>
            <br>
              ...
              <div class="card">
                <div class="card-header">
                  <div class="row">
                    ...
                    <div class="col-4">
                      <h3 class="float-left">Penjualan Produk</h3> <br>
                    ...
                    @foreach ($produk as $d)
                        @php
                            $produk_terjual += $d->qty_terjual;
                            $total_penjualan += $d->total_terjual;
                        @endphp
                    @endforeach
                    ...
                    <div class="col-4 ">
                      <div class="info-box mb-3 ">
                        ...
                        <div class="info-box-content">
                          ...
                          <span class="info-box-number">{{ number_format($produk_terjual,0) }}</span>
                        </div>
                        <!-- /.info-box-content -->
                      </div>
                      <!-- /.info-box -->
                    ...
                    <table class="table table-striped" id="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{ $p->kategori }}</td>
                          <td>{{ $p->qty_terjual }}</td>
                          <td>Rp. {{ number_format($p->total_terjual,2) }}</td>
                        </tr>
                        @endforeach
                      </tbody>
                    </table>
...
<script>
    ...
    const ctx = document.getElementById('perproduk');
