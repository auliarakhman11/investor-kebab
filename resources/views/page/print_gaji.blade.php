      ...
      <table>
        ...
        <tbody>
            <tr>
                ...
                <td style="text-align: center;">{{ $dt_gaji->audit }}</td>
                <td style="text-align: center;">{{ $dt_gaji->ms + $dt_gaji->leader + $dt_gaji->rolling }}</td>
                <td style="text-align: center;">{{ $dt_gaji->persen1 }}%</td>
                <td style="text-align: center;">{{ $dt_gaji->persen2 }}%</td>
            </tr>
        </tbody>
        <tbody>
                
            <tr>
                <td colspan="5" class="grand total"><strong>Gaji Pokok</strong></td>
                <td class="grand total"><strong>{{ number_format($dt_gaji->gapok,0) }}</strong></td>
            </tr>
            <tr>
                <td colspan="5" class="grand total"><strong>Gaji Persen</strong></td>
                <td class="grand total"><strong>{{ number_format($dt_gaji->gaji_persen,0) }}</strong></td>
            </tr>
            <tr>
                <td colspan="5" class="grand total"><strong>Kasbon</strong></td>
                <td class="grand total"><strong>{{ number_format($dt_gaji->kasbon,0) }}</strong></td>
            </tr>
            <tr>
                <td colspan="5" class="grand total"><strong>Total Gaji</strong></td>
